...
namespace nhlmvcv10.Controllers
{
    public class CoachsController : Controller
    {
        ...
        public CoachsController(NHLContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,lastname,firstname")] Coach coach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,lastname,firstname")] Coach coach)
        {
            if (id != coach.id)
            {
                return NotFound();
